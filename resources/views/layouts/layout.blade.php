...
<body>
    ...
    <header class="header_area">
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    <a class="navbar-brand logo_h" href="index.html"><img src="{{ asset('assets/img/logoapiks.png') }}"
                            alt=""></a>
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
                            @if (Auth::guard('costumer')->check())
                                ...
                                <li class="nav-item @yield('kontak')"><a class="nav-link" href="/contact">Contact</a>
                                </li>
                            @else
                                <li class="nav-item @yield('index')"><a class="nav-link"
                        ...
                        <ul class="nav-shop">
                            ...
                            @if (Auth::guard('costumer')->check())
                                <li class="nav-item"><button><a href=" {{ route('home.orderdetail') }} "><i
                                                class="ti-list"></i></a></button></li>
                                ...
                                <li class="nav-item submenu dropdown">
                                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"
                                        ...
                                        style="color: #C34546">{{ Auth::guard('costumer')->user()->name }}</a>
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <ul class="dropdown-menu">
                                            <li class="nav-item"><a class="nav-link"
                                                    href="{{ route('costumer.logout') }}"
                                                    onclick="event.preventDefault();
                                    this.closest('form').submit();"
                                                    style="color: #C34546"> {{ __('Logout') }}</a></li>
                                        </ul>
                                    </form>
                                </li>
                    </div>
    ...
    <!--================ Start footer Area  =================-->
    <footer class="footer">
        <div class="footer-area" style="background-color: #C34546">
            <div class="container">
                <div class="row section_gap">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-footer-widget tp_widgets">
                            <h4 class="footer_title large_title text-white">Our Mission</h4>
                            <p class=" text-white">
                    ...
                    <div class="offset-lg-1 col-lg-2 col-md-6 col-sm-6">
                        <div class="single-footer-widget tp_widgets">
                            ...
                            <ul class="list">
                                ...
                                <li><a href="{{ route('home.product') }}" class=" text-white">Produk</a></li>
                        ...
                        <div class="single-footer-widget instafeed">
                            ...
                            <ul class="list instafeed d-flex flex-wrap">
                                @foreach ($products as $row)
                                    <li><img src="{{ asset('storage/products/' . $row->image) }}" class="img-fluid"
                                            style="height: 70px;" alt=" {{ $row->name }} "></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
        ...
        <div class="footer-bottom" style="background-color: #E8E8E8">
            <div class="container">
                <div class="row d-flex">
                    <p class="col-lg-12 footer-text text-center text-dark">
                        Copyright &copy;
                        <script>
                            document.write(new Date().getFullYear());
                        </script> All rights reserved | Apik Shop
                    </p>
                </div>
            </div>
        </div>
